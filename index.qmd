...
Class meetings are Tuesdays and Thursdays 2:00pm-3:15pm in ECCR 1B51.

Please check the following calendar for the latest information about office hours and other class events.

<iframe src="https://calendar.google.com/calendar/embed?height=600&wkst=1&bgcolor=%23ffffff&ctz=America%2FDenver&mode=AGENDA&src=Y19jZDlkY2M4YzYyMWJiNDRkZGZlNDc2NTE1MTY2NTdmYzNkOGMyYWY5MmIyOTZmMzNmZWI4Nzg0OTY2NWY4YjE3QGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&color=%23B39DDB" style="border: 0" width="800" height="400" frameborder="0" scrolling="no"></iframe>
...
[![](https://github.com/bechang.png?size=100)](https://github.com/bechang) <br/>
[Prof. Bor-Yuh Evan Chang](https://plv.colorado.edu/bec/) <br/>
**Regular Office Hours**: Tue 3:15pm-4:00pm and Thu 1:00pm-1:45pm in ECCS 121C (inside ECCS 121)

## Course Assistant

[![](https://github.com/octalsrc.png?size=100)](https://github.com/octalsrc) <br/>
[Nicholas V. Lewchenko](https://www.octalsrc.org/research) <br/>
**Regular Office Hours**: Wed 2:30pm-3:30pm and Fri 10:30am-11:30am in ECCS 114G
...
*   **[Homework Assignments](assignments.html#homeworks)** (35%). There will be homework assignments for the first part of course. This is a project-based course, so assignments will be the main learning vehicle.
*   **A Final Exam** (30%).
...
- **Private**. The course Canvas contains any links that are limited to enrolled students. From Canvas, you will find resources like the Piazza discussion forum, private project repositories, submission links, grades, feedback, and sign-ups.
...
This course is also offered through [distance education](https://www.colorado.edu/graduateschool/distance-education). All assignment submission and content delivery will be electronic with the option to join the class live.
...
[Prof. Westley Weimer](https://web.eecs.umich.edu/~weimerw/) at the University of Michigan,
[Prof. Robert Harper](http://www.cs.cmu.edu/~rwh/) at Carnegie Mellon University, and
[Dr. Matthew A. Hammer](http://matthewhammer.org).
